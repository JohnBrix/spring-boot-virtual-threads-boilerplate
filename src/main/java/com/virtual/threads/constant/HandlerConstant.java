 ...
 * @version $Id: HandlerConstant.java, v 0.1 2025-05-27 9:23 PM John Brix Pomoy Exp $$
 */
public class HandlerConstant {
    ...
    public static final String HTTP_KYC_RESPONSE = "HTTP_KYC_RESPONSE";
    public static final String KYC_EXCEPTION = "KYC_EXCEPTION";
    public static final String API_DOCUMENTS_LINK = "www.sample.com/api/v1";
